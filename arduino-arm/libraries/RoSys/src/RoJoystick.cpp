 ...
 * \其他：无
 */
RoJoystick::RoJoystick(uint8_t port)
{
 ...
 * \其他：无
 */	
RoJoystick::RoJoystick(uint8_t x_pin,uint8_t y_pin)
{
	_X_axis_pin = x_pin;
	_Y_axis_pin = y_pin;
}
 ...
 * \其他：无
 */
void RoJoystick::setPin(uint8_t port)
{
	_X_axis_pin = Ex_Double_Analog[port].a1;
	_Y_axis_pin = Ex_Double_Analog[port].a2;
}
 ...
 * \其他：无
 */
void RoJoystick::setPin(uint8_t x_pin,uint8_t y_pin)
{
	_X_axis_pin = x_pin;
	_Y_axis_pin = y_pin;
}
 ...
 * \其他：无
 */
int16_t RoJoystick::read(uint8_t index)
{
	int16_t value = 0;
	if( index == 1 )
	{
 ...
 * \其他：无
 */
void RoJoystick::calCenterValue(int16_t x_offset,int16_t y_offset)
{
	_X_offset = x_offset;
	_Y_offset = y_offset;
}
 ...
 * \其他：无
 */
float RoJoystick::offcenter(void)
{
	long dx   = abs(readX());
	long dy   = abs(readY());
