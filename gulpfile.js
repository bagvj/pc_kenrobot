/**
 * 引入 gulp及组件
 * npm install --save-dev gulp gulp-if gulp-ruby-sass gulp-clean-css gulp-autoprefixer gulp-requirejs-optimize gulp-minify-html fs-extra minimist run-sequence electron@1.6.15 electron-builder@19.48.3 gulp-sftp q hasha nconf globby isutf8 gulp-babel babel-core babel-preset-es2015 del asar 7zip-bin gulp-uglify browserify vinyl-source-stream vinyl-buffer
