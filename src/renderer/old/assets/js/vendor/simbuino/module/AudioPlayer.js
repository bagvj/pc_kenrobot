define(['vendor/class', '../core/AtmelContext', '../core/AtmelIO', '../core/AtmelProcessor'], function(Class, AtmelContext, AtmelIO, AtmelProcessor) {
	var AudioPlayer = Class({
		constructor: function() {
			...
			if (AudioContext) {
				...
				AtmelContext.RAM[AtmelIO.OCR2B].OnRegisterChanged.push(function(oldVal, newVal) {
					self.reg_OnRegisterChanged(oldVal, newVal)
				});
