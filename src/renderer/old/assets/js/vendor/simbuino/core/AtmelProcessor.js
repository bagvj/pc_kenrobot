define(['./AtmelContext', './AtmelIO', './AtmelFlagsRegister'], function(AtmelContext, AtmelIO, AtmelFlagsRegister) {
				...
				[
					...
					// SPM
					{
						...
						Handler: function() {
							...
							if ((addr >= 0) && (addr < AtmelProcessor.BootloaderAddr) && (AtmelContext.PC >= AtmelProcessor.BootloaderAddr))
