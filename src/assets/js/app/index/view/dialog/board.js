define(['vendor/jquery', 'vendor/lodash', 'vendor/perfect-scrollbar', 'app/common/util/util', 'app/common/util/emitor', 'app/common/config/config'], function($1, _, $2, util, emitor, config) {
	var dialogWin;
	var types;
	var filter;
	var boardList;
