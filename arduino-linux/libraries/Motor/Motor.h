...
public:
	...
	Motor(int pwm1, int dir1, const char* en1);

	Motor(int pwm1, int dir1, int pwm2, int dir2);

	Motor(int pwm1, int dir1, int en1, int pwm2, int dir2);
	Motor(int pwm1, int dir1, const char* en1, int pwm2, int dir2);

	Motor(int pwm1, int dir1, int en1, int pwm2, int dir2, int en2);
	Motor(int pwm1, int dir1, const char* en1, int pwm2, int dir2, const char* en2);
...
private:
	int _pwmPin1, _pwmPin2, _dirPin1, _dirPin2, _en1, _en2;
