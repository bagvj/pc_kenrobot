 ...
 * 
 *      1.void begin(void)
 *      2.boolean NfcAdapter::tagPresent(unsigned long timeout) NfcAdapter.h
 *      3.boolean MifareUltralight::clean()    MifareUltralight.h  
 *      4.boolean NfcAdapter::erase()          NfcAdapter.h
 *      5.NfcTag MifareClassic::read(byte *uid, unsigned int uidLength)        MifareClassic.h
 *      6.boolean MifareClassic::write(NdefMessage& m, byte * uid, unsigned int uidLength)  MifareClassic.h
 *
 * \修订历史
