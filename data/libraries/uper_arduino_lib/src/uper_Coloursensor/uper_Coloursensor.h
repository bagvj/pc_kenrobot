#ifndef UPER__TCS34725__H
#define UPER__TCS34725__H
...
class uper_Coloursensor {
 public:
		...
		*/
  uper_Coloursensor(tcs34725IntegrationTime_t = TCS34725_INTEGRATIONTIME_2_4MS, tcs34725Gain_t = TCS34725_GAIN_1X);
		/*!
