...
public:
  ...
  //Displayes two numbers
  //@num1 Number on the left
  //@param point When true, show the colon mark;
  void showTwoNumberDec(uint8_t num1,uint8_t num2,bool piont);
  ...
  //!@param isShow When true,display; When false, hide;
