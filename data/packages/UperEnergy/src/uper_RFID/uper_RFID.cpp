 ...
 * 
 *      1.void begin(void)
 *      2.u8 MifareWriteBlock(u8 block, u8 *buf)  //返回值:0 写卡失败; 1 写卡成功，参数:block 第几个块，数字是从4开始到7;*buf 写入的字符串
 *      3.u8 MifareReadBlock(u8 block, u8 *buf)    //返回值:0 读卡失败; 1 读卡成功
 *      4.u8 MifareAuthentication(u8 type, u8 block, u8 *uuid, u8 uuid_len, u8 *key)
 * \修订历史
...
*/
/*****************************************************************************/
UPER_RFID_Module::UPER_RFID_Module(void)
{
...
*/
/*****************************************************************************/
void UPER_RFID_Module::begin(void)
{
#ifdef PN532DEBUG
    u8 i;
#endif
...
*/
/*****************************************************************************/
u32 UPER_RFID_Module::get_version(void)
{
    u32 version;
...
*/
/*****************************************************************************/
u8 UPER_RFID_Module::SAMConfiguration(u8 mode, u8 timeout, u8 irq)
{
#ifdef PN532DEBUG
...
*/
/*****************************************************************************/
u8 UPER_RFID_Module::InListPassiveTarget(u8 *buf, u8 brty, u8 maxtg, u8 *idata)
{
...
*/
/*****************************************************************************/
u8 UPER_RFID_Module::MifareAuthentication(u8 type, u8 block,
...
*/
/*****************************************************************************/
u8 UPER_RFID_Module::MifareReadBlock(u8 block, u8 *buf)
{
    nfc_buf[0] = PN532_COMMAND_INDATAEXCHANGE;
    nfc_buf[1] = 1; // logical number of the relevant target
...
*/
/*****************************************************************************/
u8 UPER_RFID_Module::MifareWriteBlock(u8 block, u8 *buf)
{
    nfc_buf[0] = PN532_COMMAND_INDATAEXCHANGE;
    nfc_buf[1] = 1; // logical number of the relevant target
...
*/
/*****************************************************************************/
u8 UPER_RFID_Module::P2PInitiatorInit()
{
...
*/
/*****************************************************************************/
u8 UPER_RFID_Module::P2PTargetInit()
{
    /** avoid resend command */
    static u8 send_flag=1;
...
*/
/*****************************************************************************/
u8 UPER_RFID_Module::P2PInitiatorTxRx(u8 *t_buf, u8 t_len, u8 *r_buf, u8 *r_len)
{
//    wait_ready();
//    wait_ready();
    wait_ready(15);
...
*/
/*****************************************************************************/
u8 UPER_RFID_Module::P2PTargetTxRx(u8 *t_buf, u8 t_len, u8 *r_buf, u8 *r_len)
{
...
*/
/*****************************************************************************/
u8 UPER_RFID_Module::TgInitAsTarget()
{
    nfc_buf[0] = PN532_COMMAND_TGINITASTARGET;
    /** 14443-4A Card only */
    nfc_buf[1] = 0x04;
...
*/
/*****************************************************************************/
u8 UPER_RFID_Module::TargetPolling()
{
...
*/
/*****************************************************************************/
u8 UPER_RFID_Module::SetParameters(u8 para)
{
...
*/
/*****************************************************************************/
u8 UPER_RFID_Module::write_cmd_check_ack(u8 *cmd, u8 len)
{
    write_cmd(cmd, len);
    wait_ready();
#ifdef PN532DEBUG
...
*/
/*****************************************************************************/
inline u8 UPER_RFID_Module::send(u8 data)
{
#if ARDUINO >= 100
...
*/
/*****************************************************************************/
inline u8 UPER_RFID_Module::receive(void)
{
#if ARDUINO >= 100
    return Wire.read();
#else
...
*/
/*****************************************************************************/
void UPER_RFID_Module::puthex(u8 data)
{
...
*/
/*****************************************************************************/
void UPER_RFID_Module::puthex(u8 *buf, u32 len)
{
    u32 i;
    for(i=0; i<len; i++)
    {
...
*/
/*****************************************************************************/
void UPER_RFID_Module::write_cmd(u8 *cmd, u8 len)
{
    uint8_t checksum;
...
*/
/*****************************************************************************/
void UPER_RFID_Module::read_dt(u8 *buf, u8 len)
{
    delay(2);
...
*/
/*****************************************************************************/
u8 UPER_RFID_Module::read_ack(void)
{
    u8 ack_buf[6];
...
*/
/*****************************************************************************/
u8 UPER_RFID_Module::read_sta(void)
{
    /**
...
*/
/*****************************************************************************/
u8 UPER_RFID_Module::wait_ready(u8 ms)
{
    delay(ms);
    return PN532_I2C_READY;
}
