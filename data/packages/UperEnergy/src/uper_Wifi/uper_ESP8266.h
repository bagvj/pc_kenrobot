#ifndef __UPER_ESP8266_H__
#define __UPER_ESP8266_H__

#include "Arduino.h"

//#define UPER_ESP8266_USE_SOFTWARE_SERIAL

#ifdef UPER_ESP8266_USE_SOFTWARE_SERIAL
#include "uper_SoftwareSerial.h"
#endif
...
/**
 * Provide an easy-to-use way to manipulate UPER_ESP8266. 
 */
class UPER_ESP8266 {
 public:
     ...
     * @param baud - the buad rate to communicate with UPER_ESP8266(default:9600). 
     *
     * @warning parameter baud depends on the AT firmware. 9600 is an common value. 
     */
#if (USER_SEL_VERSION == VERSION_22)
    UPER_ESP8266(SoftwareSerial &uart, uint32_t baud = 115200);
#elif (USER_SEL_VERSION == VERSION_18)
    UPER_ESP8266(SoftwareSerial &uart, uint32_t baud = 9600);
     ...
     */
#if (USER_SEL_VERSION == VERSION_22)
    UPER_ESP8266(HardwareSerial &uart, uint32_t baud = 115200);
#elif (USER_SEL_VERSION == VERSION_18)
    UPER_ESP8266(HardwareSerial &uart, uint32_t baud = 9600);
#endif /* #if(USER_SEL_VERSION == VERSION_22) */


#endif /* #ifdef UPER_ESP8266_USE_SOFTWARE_SERIAL */
    
    
    /** 
     * Verify UPER_ESP8266 whether live or not. 
     *
     * Actually, this method will send command "AT" to UPER_ESP8266 and waiting for "OK". 
     * 
     * @retval true - alive.
     * @retval false - dead.
     */
    ...
    /**
     * Restart UPER_ESP8266 by "AT+RST". 
     *
    ...
    /**
     * Get the IP address of UPER_ESP8266. 
     *
     * @return the IP list. 
     */
...
#ifdef UPER_ESP8266_USE_SOFTWARE_SERIAL
    SoftwareSerial *m_puart; /* The UART to communicate with UPER_ESP8266 */
#else
    HardwareSerial *m_puart; /* The UART to communicate with UPER_ESP8266 */
#endif
};

#endif /* #ifndef __UPER_ESP8266_H__ */
