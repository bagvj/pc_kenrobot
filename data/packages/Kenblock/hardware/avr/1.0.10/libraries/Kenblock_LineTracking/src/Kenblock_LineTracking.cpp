 ...
 * \其他：无
 */
LineTracking::LineTracking(void)
{
 ...
 * \其他：无
 */
LineTracking::LineTracking(uint8_t port)
{
...
LineTracking::LineTracking(uint8_t sen1,uint8_t sen2,uint8_t sen3,uint8_t sen4)
{
	_Sensor1 = sen1;
	_Sensor2 = sen2;
	_Sensor3 = sen3;
 ...
 * \其他：无
 */
void LineTracking::setPin(uint8_t port)
{
	_Sensor1 = Ex_Quadruple_Digital[port].d1;
	_Sensor2 = Ex_Quadruple_Digital[port].d2;
	_Sensor3 = Ex_Quadruple_Digital[port].d3;
 ...
 * \其他：无
 */
void LineTracking::setPin(uint8_t sen1,uint8_t sen2,uint8_t sen3,uint8_t sen4)
{
	_Sensor1 = sen1;
	_Sensor2 = sen2;
	_Sensor3 = sen3;
 ...
 * \其他：传感器位于黑线上方时，输出高电平。
 */
uint8_t LineTracking::readSensors(void)
{
	uint8_t State = 0;
 ...
 * \其他：传感器位于黑线上方时，输出高电平。
 */
uint8_t LineTracking::readSensors(uint8_t sen)
{
	uint8_t SensorNum = 0;
	SensorNum = sen;
	switch(SensorNum)
