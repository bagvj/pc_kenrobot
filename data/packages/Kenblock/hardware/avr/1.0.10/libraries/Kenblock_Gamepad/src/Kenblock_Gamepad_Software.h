 ...
 * @名称：  Kenblock_Gamepad_Software.h
 * @作者：  Kenblock
 * @版本：  V0.4.5
 * @时间：  2018/1/30
 * @描述：  2.4G遥控手柄 Kenblock_Gamepad_Software.c 的头文件。
 *
 * \说明
 * 2.4G 遥控手柄。
 *
...
#ifndef Kenblock_Gamepad_Software_H
#define Kenblock_Gamepad_Software_H
#include <Arduino.h>
...
class Gamepad_Software      
{
	public:
	
	Gamepad_Software(SoftwareSerial &uart);
