 ...
 * 		3.ConnectWiFi.ino			//Station模式 连接WiFi。
 * 		4.其他：若要支持UNO，请自行修改测试。
 */
#ifndef __ESP8266_SoftSer_H__
#define __ESP8266_SoftSer_H__
...
#endif /* #ifndef __ESP8266_SoftSer_H__ */
