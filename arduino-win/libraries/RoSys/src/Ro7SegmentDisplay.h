 ...
 * @名称：  Ro7SegmentDisplay.h
 * @作者：  RoSys
 * @版本：  V1.0.0
 * @时间：  2016/10/10
 * @描述：  四位数码管的驱动。Ro7SegmentDisplay.cpp 的头文件。
 *
 * \说明
...
#ifndef Ro7SegmentDisplay_H
#define Ro7SegmentDisplay_H
...
const uint8_t BRIGHTNESS_7 = 7;
 ...
 /**
 * Class: Ro7SegmentDisplay
 * \说明：Class Ro7SegmentDisplay 的声明
 */
...
class Ro7SegmentDisplay
{
	public:
		 ...
		 * \其他：无
		 */
		Ro7SegmentDisplay(uint8_t port);
		 ...
		 * \其他：无
		 */
		Ro7SegmentDisplay(uint8_t dataPin, uint8_t clkPin);
